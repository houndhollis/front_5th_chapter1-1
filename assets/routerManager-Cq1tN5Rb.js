...
`,n=e=>{const t=i.isProduct?"/front_5th_chapter1-1":"";i.mode==="history"&&(window.history.pushState(null,null,`${t}${e}`),u()),i.mode==="hash"&&(window.location.hash=`#${e}`)},d={get(e){return JSON.parse(localStorage.getItem(e))},set(e,t){return localStorage.setItem(e,t)},remove(e){return localStorage.removeItem(e)}};let a={};const c={login(e){a={username:e,email:"",bio:""},d.set("user",JSON.stringify(a))},logout(){a=null,d.remove("user")},getUserState(){return a||(a=d.get("user")),a},getUserProfile(){return this.getUserState()},checkIsLoginStatus(){return!!this.getUserState()},updateUserProfile(e,t,r){a={username:e,email:t,bio:r},d.set("user",JSON.stringify(a))}},p=()=>{a=d.get("user")};p();const h=e=>{e&&(e.addEventListener("click",t=>{const r=t.target.closest("a");if(r){if(t.preventDefault(),r.id==="logout"){c.logout(),n("/login");return}n(r.pathname)}}),e.addEventListener("submit",t=>{if(t.preventDefault(),t.target.id==="login-form"){const r=t.target.elements.username.value;if(!r)return alert("사용자 이름을 입력해주세요.");c.login(r),n("/profile")}if(t.target.id==="profile-form"){const r=t.target.elements.username.value,o=t.target.elements.email.value,s=t.target.elements.bio.value;c.updateUserProfile(r,o,s),alert("프로필이 업데이트되었습니다.")}}))},x=e=>{e&&(e.addEventListener("click",t=>{const r=t.target.closest("a");if(r){if(t.preventDefault(),r.id==="logout"){c.logout(),n("/login");return}n(r.getAttribute("href"))}}),e.addEventListener("submit",t=>{if(t.preventDefault(),t.target.id==="login-form"){const r=t.target.elements.username.value;if(!r)return alert("사용자 이름을 입력해주세요.");c.login(r),n("/profile")}if(t.target.id==="profile-form"){const r=t.target.elements.username.value,o=t.target.elements.email.value,s=t.target.elements.bio.value;c.updateUserProfile(r,o,s),alert("프로필이 업데이트되었습니다.")}}))},u=()=>{const e=document.getElementById("root"),t=i.getRoute(),r=c.checkIsLoginStatus(),o=i.mode==="history"?window.location.pathname:window.location.hash||"#/";if(i.mode==="history"){if(o==="/profile"&&!r)return n("/login");if(o==="/login"&&r)return n("/")}else{if(o==="#/profile"&&!r)return n("/login");if(o==="#/login"&&r)return n("/")}console.log(t,o);const s=t[o]||b;if(e.innerHTML=s(),!i.isEventAttached)return i.isEventAttached=!0,i.mode==="history"?h(e):x(e)};window.addEventListener("popstate",u);window.addEventListener("hashchange",u);const f=()=>`
...
`,$=()=>{const e=c.getUserProfile();return`
  <div id="root">
    <div class="bg-gray-100 min-h-screen flex justify-center">
      <div class="max-w-md w-full">
        ${g()}
